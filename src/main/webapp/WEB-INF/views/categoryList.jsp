...
<tr>
<th>Sr No.</th><th>CID</th><th>Name</th><th class="span2">Action</th>
</tr>
<c:if test="${empty catList }"><tr>
...
<a class="btn btn-info" role="button" href="<c:url value="/admin/deleteCategory/${c.cid }"/>">Delete</a>
<a class="btn btn-info" role="button" href="${contextRoot }/admin/updateCategory?cid=<c:out value="${c.cid }"> </c:out>">Update</a></td>
</c:forEach>
