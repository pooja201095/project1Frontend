...
<body>
<div class="container">
    <h2><img  src="${pageContext.request.contextPath}/resource/Images/cart2.png" style="width: 50px; height: 50px;">CART</h2>
        ...
        <tbody>
            ...
            <c:forEach var="c" varStatus="st" items="${CartInfo }" >
                <tr>
                    ...
                    <td><img src="${pageContext.request.contextPath}/resource/<c:out value='${c.cartImage }'></c:out>"height="50px" width="50px"></td>
            ...
            <tr>
                ...
                <td>
                    <span class="col-lg-9" align="right"> <lable>Grand Total:</lable> &nbsp<c:out value="${gtot }"></c:out></span>
                </td>
            </tr>
        </tbody>
        ...
        <tfoot>
            <tr>
                ...
                <c:if test="${not empty CartInfo}">
                    <td><a href="${pageContext.request.contextPath}/Checkout" class="btn btn-success btn-block">
